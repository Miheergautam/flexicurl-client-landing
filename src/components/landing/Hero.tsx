...
export default function Hero() {
  return (
    <section id="hero" className="relative overflow-hidden bg-[#ebf2fe]">
      <div className="absolute inset-0 bg-gradient-to-b from-[#ebf2fe] via-white to-[#ebf2fe]" />
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16 sm:py-20 lg:py-24">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div className="space-y-6">
            <p className="inline-flex items-center rounded-full bg-white/80 px-4 py-2 text-xs font-semibold uppercase tracking-wide text-[#4987d2] shadow-sm shadow-[#4987d2]/10 ring-1 ring-white/60">
            ...
            <p className="text-lg leading-relaxed text-slate-600 sm:max-w-xl">
            ...
            <div className="flex items-center gap-4 text-sm text-slate-600">
              <span className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-[#afcaed] text-[#1f3f6d] font-semibold shadow-sm shadow-[#4987d2]/15">
                4.9
              </span>
              <div>
          ...
          <div className="relative">
            ...
            <div className="relative grid gap-4">
              <div className="rounded-2xl bg-white shadow-md shadow-[#4987d2]/10 ring-1 ring-white/60 p-6">
                <div className="flex items-center justify-between">
                  <p className="text-sm font-semibold text-slate-700">
                    Today&apos;s Activity
                  </p>
                  <span className="text-xs font-semibold text-[#4987d2] bg-[#ebf2fe] px-2 py-1 rounded-full">
                    On Track
                  </span>
                </div>
                <div className="mt-4 grid grid-cols-3 gap-3">
                  <div className="rounded-xl bg-[#f5f9ff] p-3 shadow-sm shadow-[#4987d2]/5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="rounded-2xl bg-white p-6 shadow-md shadow-[#4987d2]/10 ring-1 ring-white/60">
                  <p className="text-sm font-semibold text-slate-700">
                    Calorie Burn
                  </p>
                  <div className="mt-4 h-28 rounded-xl bg-gradient-to-b from-[#ebf2fe] to-white p-4 shadow-inner">
                ...
                <div className="rounded-2xl bg-[#f5f9ff] p-6 shadow-md shadow-[#4987d2]/10 ring-1 ring-white/60">
                  <div className="flex items-center justify-between">
                    <p className="text-sm font-semibold text-slate-700">
                      Member Progress
                    </p>
                  ...
                  <div className="mt-4 space-y-3">
                    {[
                      ...
                      <div key={item.label}>
                        ...
                        <div className="mt-1 h-2 w-full rounded-full bg-white shadow-inner">
                          <div
              ...
              <div className="rounded-2xl bg-white p-5 shadow-md shadow-[#4987d2]/10 ring-1 ring-white/60 flex items-center justify-between">
                <div>
